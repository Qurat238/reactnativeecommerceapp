...
const AllReviews = () => {
  ...
  }, [productId, dispatch, navigation, isDeleted, deleteError, error]);

  const deleteReviewHandler = (reviewId) => {
    dispatch(deleteReviews(reviewId, productId));
  };

  const productReviewSubmitHandler = (id) => {
          ...
          <SafeAreaView>
            <ScrollView>
              ...
              <View style={{ marginBottom: 50 }}>
                ...
                <Button
                  style={styles.btn}
                  onPress={() => productReviewSubmitHandler(productId)}
                >
                  <View>
                      ...
                      <View style={styles.ReviewContent}>
                        ...
                        >
                          ...
                          <Rating
                            ...
                            style={styles.rating}
                          />
                          <Button onPress={() => deleteReviewHandler(item._id)}>
                            <View>
