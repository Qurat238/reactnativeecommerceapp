        ...
        <View>
          <ScrollView>
            <SafeAreaView>
                ...
                <Carousel
                  ...
                  renderItem={({ item }) => (
                    <Image
                      style={[
                        styles.image,
                        { width: width * 0.67, height: height * 0.333 },
                      ]}
                      source={{ uri: item }}
                    />
                  )}
              ...
              <View
                style={[styles.contentContainer, { height: height * 0.64 }]}
              >
                ...
                >
                  <View style={styles.Btn}>
                    <Text
                      style={[styles.BtnText, { marginLeft: width * 0.05 }]}
                    >
                      Reviews
                    </Text>
                  ...
                  <View style={styles.Btn}>
                    ...
                    <Button onPress={addToCartHandler}>
                      <View>
                        <Icon2
                          name="arrow-forward"
                          size={30}
          ...
          >
            <View style={styles.modalContainer}>
              <View style={[styles.modalContent, { height: height * 0.637 }]}>
            ...
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                ...
                <View style={styles.reviewForm}>
                  ...
                  />
                  <TextInput
                    style={[styles.textArea, { height: height * 0.333 }]}
